...
export default function GuidancePage() {
  ...
  return (
    <InnerPageShell>
      <PageHero eyebrow="Her adımda yanında" title="Kendini tanıyan öğrenci, geleceğini daha güçlü tasarlar." description="Rehberlik yaklaşımımız; akademik başarıyı, iyi oluşu, kariyer farkındalığını ve aile iletişimini tek bir gelişim yolculuğunda ele alır." image="/images/activities/social/vision-board-etkinligi/vision-board-etkinligi-01.webp" imagePosition="center 55%" current="Rehberlik" />
