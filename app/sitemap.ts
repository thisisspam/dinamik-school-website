...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const routes = ["", "/bolumler", "/okulumuz", "/hakkimizda", "/okul-kiyafetlerimiz", "/kadromuz", "/faaliyetlerimiz", "/galeri", "/basarilarimiz", "/rehberlik", "/iletisim", "/on-kayit", "/kvkk", "/erisilebilirlik"];
  return [
