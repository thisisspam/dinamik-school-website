...
const BLOCK_HINTS: Record<DepartmentContentBlockType, string> = {
  ...
  "program-showcase": "İlk satırlara giriş metnini yazın. Grup başlıklarını ## Başlık biçiminde ekleyip altlarına her satırda bir uygulama yazın.",
